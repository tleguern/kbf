...
t 0 'prevzero.res'	'prevzero.b'	'-o optimised-operands -t 10'
t 0 'prevzero_op.res'	'prevzero_op.b'	'-O0 -t 10'
t 0 'nextzero.res'	'nextzero.b'	'-o optimised-operands -t 10'
t 0 'nextzero_op.res'	'nextzero_op.b'	'-O0 -t 10'
t 0 'zero.res'		'zero.b'	'-o optimised-operands -t 2'
